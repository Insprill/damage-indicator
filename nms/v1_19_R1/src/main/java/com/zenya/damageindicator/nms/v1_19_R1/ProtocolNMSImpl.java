package com.zenya.damageindicator.nms.v1_19_R1;
    ...
    public static class HologramImpl implements Hologram {
        ...
        public Hologram spawn(double offset, double speed, long duration) {
            ...
            new BukkitRunnable() {
                ...
                @Override
                public void run() {
                    armorStand.teleportTo(entity.getEyeLocation().getX(), entity.getEyeLocation().getY() + dy, entity.getEyeLocation().getZ());
                    sendTeleportPacket();
                    dy += speed;
