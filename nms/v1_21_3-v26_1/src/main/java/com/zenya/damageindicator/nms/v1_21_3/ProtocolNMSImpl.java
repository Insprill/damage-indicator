...
public class ProtocolNMSImpl implements ProtocolNMS {
    ...
    public static class HologramImpl implements Hologram {
        ...
        public void sendTeleportPacket(Location loc) {
            ...
            ClientboundTeleportEntityPacket teleport = new ClientboundTeleportEntityPacket(armorStand.getId(), PositionMoveRotation.of(armorStand), Set.of(), armorStand.onGround());
            sendPacket(teleport);
        }
